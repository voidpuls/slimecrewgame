  ...
  self.addEventListener("install", (e) => {
    e.waitUntil(
      caches.open("game-cache").then((cache) => {
        return cache.addAll([
          "index.pck",   // The game data file
          "index.wasm",  // The WebAssembly file
          "index.html",  // The main HTML file
          "index.js",    // JavaScript code for the game
          "coi-serviceworker.min.js",  // The service worker itself
          "cache_game.js", // The cache script
          // Add any other assets required for the game
        ]);
      })
    );
  });
    ...
    e.respondWith(
      caches.match(e.request).then((cachedResponse) => {
        ...
        return fetch(e.request).then((response) => {
          ...
          if (e.request.url.includes('index.pck') || e.request.url.includes('index.wasm')) {
            caches.open('game-cache').then((cache) => {
