    ...
    e.respondWith(
      fetch(s)
        .then((response) => {
          ...
          headers.set("Cross-Origin-Opener-Policy", "same-origin"); // Ensure safe interaction with cross-origin resources

          // Set additional headers to explicitly allow all cross-origin resources
